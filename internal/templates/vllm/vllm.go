...
func (d *Driver) Definition() templates.Definition {
	return templates.Definition{
		...
		Fields: []templates.Field{
			...
			{Key: "max_model_len", Label: "Max model length (tokens)", Type: templates.FieldNumber, Required: true, Default: "8192", Description: "Context window passed as --max-model-len. Must fit in GPU memory.", Group: "serving"},
