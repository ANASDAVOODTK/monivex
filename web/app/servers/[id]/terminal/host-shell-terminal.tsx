...
export default function HostShellTerminal({ serverId }: { serverId: string }) {
  ...
  useEffect(() => {
    ...
    async function init() {
      ...
      terminal.writeln('\x1b[1;36m* Connecting to host shell...\x1b[0m');

      const url = wsUrl(`/ws/servers/${encodeURIComponent(serverId)}/shell`);
